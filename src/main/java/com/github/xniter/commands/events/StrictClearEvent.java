...
public class StrictClearEvent {
    ...
    public void StrictLagRemovalEvent(TickEvent.ServerTickEvent event) {
        ...
        if (LagRemoval.LRConfig.EnableStrictLagremoval()) {
            if (this.seconds == LagRemoval.LRConfig.StrictTimerInterval() * 60 - 30 && !this.w30) {
            ...
            if (this.seconds == LagRemoval.LRConfig.StrictTimerInterval() * 60 - 29) {
                this.w30 = false;
            }


            if (this.seconds == LagRemoval.LRConfig.StrictTimerInterval() * 60 - 5 && !this.w5) {
            ...
            if (this.seconds == LagRemoval.LRConfig.StrictTimerInterval() * 60 - 4) {
                this.w5 = false;
            }

            if (this.seconds == LagRemoval.LRConfig.StrictTimerInterval() * 60 - 3 && !this.w3) {
            ...
            if (this.seconds == LagRemoval.LRConfig.StrictTimerInterval() * 60 - 2.9) {
                this.w3 = false;
            }


            if (this.seconds == LagRemoval.LRConfig.StrictTimerInterval() * 60 - 2 && !this.w2) {
            ...
            if (this.seconds == LagRemoval.LRConfig.StrictTimerInterval() * 60 - 1.9) {
                this.w2 = false;
            }

            if (this.seconds == LagRemoval.LRConfig.StrictTimerInterval() * 60 - 1 && !this.w1) {
            ...
            if (this.seconds == LagRemoval.LRConfig.StrictTimerInterval() * 60 - 0.9) {
                this.w1 = false;
            }

            if (this.seconds == LagRemoval.LRConfig.StrictTimerInterval() * 60 && !this.w60) {
